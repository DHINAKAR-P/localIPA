...
app.controller('Profile', ['$scope', '$state', '$http', '$ionicPopup', 'RestURL', 'People_testId', 'Settings','surveyService','$rootScope','$ionicLoading','$cordovaFileTransfer',
    function ($scope, $state, $http, $ionicPopup, RestURL, People_testId, Settings,surveyService,$rootScope,$ionicLoading,$cordovaFileTransfer) {
